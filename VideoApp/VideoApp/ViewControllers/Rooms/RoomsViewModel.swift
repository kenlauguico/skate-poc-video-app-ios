...
protocol RoomsViewModel: AnyObject {
    var title: String { get }
    var sections: [RoomsViewModelSection] { get }
}

extension RoomsViewModel {
    func row(at indexPath: IndexPath) -> RoomsViewModelSection.Row {
